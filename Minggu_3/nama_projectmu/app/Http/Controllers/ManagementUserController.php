...
class ManagementUserController extends Controller
{
    ...
    public function create(){
        ...
        return "Method ini nantinya akan digunakan untuk menampilakn form untuk menambah data data user";
    }
    ...
    public function show($id){
        ...
        return "Method ini nantinya akan digunakan untuk mengambil data user dengan id=" . $id;
    }
